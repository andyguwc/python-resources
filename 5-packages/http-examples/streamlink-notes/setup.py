...
# customized options for environ variables 
...
sys_path.insert(0, srcdir) # add src to the path

# open long descriptions
with codecs.open(path.join(this_directory, "READEME.md", 'r', 'utf-8')) as f:
    long_description = f.read()

# entry point command streamlink, can triggers streamlink_cli main's main function
entry_points = {
...
setup(name="streamlink",
      ...
      packages=find_packages("src"), # this is the source directory
      package_dir={"": "src"},
