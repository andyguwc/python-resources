# https://github.com/alpacahq/alpaca-trade-api-python/blob/master/alpaca_trade_api/__main__.py
# this supports command line functionality to pass in arguments 
import argparse
